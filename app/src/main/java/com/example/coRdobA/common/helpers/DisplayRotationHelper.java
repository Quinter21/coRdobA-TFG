package com.example.coRdobA.common.helpers;
...
public final class DisplayRotationHelper implements DisplayManager.DisplayListener {
    ...
    /** Registers the display listener. Should be called from resume. */
    public void onResume() {
        displayManager.registerDisplayListener(this, null);
    }

    /** Unregisters the display listener. Should be called from pause. */
    public void onPause() {
